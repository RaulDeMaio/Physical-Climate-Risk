...
### UX & Interface
- **Hazard Education**: Add tooltips or info-boxes explaining the different **Intensity** levels (moderate, severe, extreme, very_extreme) and the underlying calibration logic.[DONE]
